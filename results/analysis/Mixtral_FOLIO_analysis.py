...
def check_steps(dataset):
    ...
    for i, instance in enumerate(dataset):
        ...
        for j, p in enumerate(instance["predicted_steps"]):
            if p == 'No steps found in reasoning.':
                continue
            ...
            if p == True:
                ...
                if truth in {"y","i"}:
                    ...
                    with open("EA/FP_Mixtral.jsonl", "a") as f:
                        pass
...
def get_f1(file):
    dataset = load_data(file, "Mixtral_FOLIO_annotations_full.jsonl")
    ...
    print("Category", "Accuracy", "Precision", "Recall", "F1", "F0.5")
...
def get_all_f1s():
    print("-----")
    file = "../reasoning/Mixtral_FOLIO-Symbolic-05_25.jsonl"
    print("Symbolic")
    get_f1(file)

    print("-----")
    file = "../reasoning/Mixtral_FOLIO-LLaMa3-05_23.jsonl"
    print("LLaMa3")
    get_f1(file)

    print("-----")
    file = "../reasoning/Mixtral_FOLIO-Deberta-05_23.jsonl"
    print("Deberta")
    get_f1(file)

    print("-----")
    file = "../reasoning/Mixtral_FOLIO-LLaMa3-direct-11_18.jsonl"
    print("LLaMa3-direct")
    get_f1(file)

    print("-----")
    file = "../reasoning/Mixtral_FOLIO-Deberta-direct-11_18.jsonl"
    print("Deberta-direct")
    get_f1(file)

    print("-----")
    file = "../reasoning/Mixtral_FOLIO-GPT-direct-12_14.jsonl"
    print("GPT direct")
    get_f1(file)
