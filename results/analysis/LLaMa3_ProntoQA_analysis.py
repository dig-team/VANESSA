...
def get_f1(file):
    dataset = load_data(file, "LLaMa3_ProntoQA_annotations.jsonl")
...
def get_all_f1s():
    print("-----")
    file = "../reasoning/LLaMa3_ProntoQA-Symbolic-05_25.jsonl"
    print("Symbolic")
    get_f1(file)

    print("-----")
    file = "../reasoning/LLaMa3_ProntoQA-LLaMa3-05_23.jsonl"
    print("LLaMa3")
    get_f1(file)

    print("-----")
    file = "../reasoning/LLaMa3_ProntoQA-Deberta-05_24.jsonl"
    print("Deberta")
    get_f1(file)

    print("-----")
    file = "../reasoning/LLaMa3_ProntoQA-LLaMa3-direct-11_14.jsonl"
    print("LLaMa3 Direct")
    get_f1(file)

    print("-----")
    file = "../reasoning/LLaMa3_ProntoQA-Deberta-direct-11_14.jsonl"
    print("DeBERTa Direct")
    get_f1(file)

    print("-----")
    file = "../reasoning/LLaMa3_ProntoQA-GPT-direct-12_14.jsonl"
    print("GPT direct")
    get_f1(file)
