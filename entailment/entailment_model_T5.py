...
class T5EntailmentModel():
    def __init__(self, model_name):
        ...
        self.tokenizer = T5Tokenizer.from_pretrained(model_name, padding_side="left")
...
"""entailment_model = T5EntailmentModel("google/flan-t5-xxl")
...
entailment_model.entail("X appear in the company today .", "X appear in the company today .")
